...
cd /var/www/bird_watching_app/bozhena_oliinyk/web1
python3 -m venv .venv
...
[Service]
User=www-data
WorkingDirectory=/var/www/bird_watching_app/bozhena_oliinyk/web1
ExecStart=/var/www/bird_watching_app/bozhena_oliinyk/web1/.venv/bin/gunicorn -w 3 -b 127.0.0.1:5000 app:app
Restart=always
